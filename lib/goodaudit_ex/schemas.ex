defmodule GoodauditEx.Schemas do
  @moduledoc """
  Generated schema structs from the GoodAudit OpenAPI specification.
        ...
        defp convert_field(key, value) do
          case Map.get(@conversions, key) do
            {:struct, ref_name} when is_map(value) ->
              Module.concat(GoodauditEx.Schemas, ref_name).from_map(value)

            {:list, ref_name} when is_list(value) ->
              mod = Module.concat(GoodauditEx.Schemas, ref_name)
