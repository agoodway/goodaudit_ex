defmodule GoodauditEx.Client do
  @moduledoc """
  HTTP client for the GoodAudit API.
    ...
    %__MODULE__{
      base_url:
        Keyword.get(opts, :base_url) ||
          Application.get_env(:goodaudit_ex, :base_url, "http://localhost:4000"),
      api_key:
        Keyword.get(opts, :api_key) ||
          Application.get_env(:goodaudit_ex, :api_key),
