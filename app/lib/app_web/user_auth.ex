defmodule GAWeb.UserAuth do
  ...
  @remember_me_cookie "_ga_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GAWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def on_mount(:load_account_context, params, _session, socket) do
    ...
    case GA.AccountContext.get_account_for_user(user, account_id) do
      {:ok, account} ->
